  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bolgxqna"
          method="POST"
          className="xl:pl-10 2xl:pl-20"
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              <label className="label reveal-up" htmlFor="name">
                Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label className="label reveal-up" htmlFor="email">
                Email
              </label>
              <input
                type="text"
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Hi!"
              required
              className="text-field resize-y min-h-32 max-h-60 reveal-up"
            ></textarea>
          </div>
          <button
            type="submit"
